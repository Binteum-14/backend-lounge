...
public enum GeneralErrorCode implements BaseErrorCode { // 실패
    ...
    JWT_UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "JWT_401", "인증이 필요합니다."),
    FORBIDDEN(HttpStatus.FORBIDDEN, "COMMON_403", "접근 권한이 없습니다."),
    NOT_FOUND(HttpStatus.NOT_FOUND, "COMMON_404", "요청한 리소스를 찾을 수 없습니다."),
    METHOD_NOT_ALLOWED(HttpStatus.METHOD_NOT_ALLOWED, "COMMON_405", "지원하지 않는 HTTP 메서드입니다."),
    DATA_INTEGRITY_VIOLATION(HttpStatus.CONFLICT, "COMMON_409", "데이터 제약조건을 위반했습니다."),
    ...
    TOKEN_INVALID(HttpStatus.UNAUTHORIZED, "JWT_403_2", "유효하지 않은 token입니다."),
    TOKEN_NO_AUTH(HttpStatus.UNAUTHORIZED, "JWT_403_3", "권한 정보가 없는 token입니다."),
